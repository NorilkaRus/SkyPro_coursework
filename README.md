...
В проекте реализована функция, которая выводит на экран список из 5 последних выполненных клиентом операций в формате:
...
- На экран выведены последние 5 выполненных (EXECUTED) операций.
